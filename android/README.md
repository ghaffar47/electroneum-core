...
# Get the apk
        ...
        docker cp electroneum-gui-android:/opt/android/electroneum-core/build/release/bin/bin/QtApp-debug.apk .
...
- Using ADB (Android debugger bridge) : 
  ...
  The only place where we are allowed to play is `/data/local/tmp`. So : 
        ...
        adb  push /opt/android/electroneum-core/build/release/bin/bin/QtApp-debug.apk /data/local/tmp
